                            ...
                            <CardContent className='flex justify-center'>
                                <div className='w-full'>
                                    <PrintBadge
                                        ...
                                        print={false}
                                        statusBackground={customization.statusColors[selectedStatus]?.background || '#000000'}
                                        statusTextColor={customization.statusColors[selectedStatus]?.text || '#ffffff'}
                                    />
                                </div>
                            </CardContent>
                        </Card>
                                        ...
                                        <div className='flex flex-wrap gap-2'>
                                            {STATUS_OPTIONS.map((option) => (
                                                <Button
                                                    ...
                                                    size="sm"
                                                    className={`cursor-pointer duration-300 ${selectedStatus === option.value ? 'bg-brand-primary hover:bg-brand-primary-dark text-white' : 'hover:bg-brand-primary hover:text-white'} `}
