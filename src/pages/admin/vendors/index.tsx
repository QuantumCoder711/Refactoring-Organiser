        ...
        <div className="h-full w-full">
            ...
            <div className="mt-10 flex flex-wrap gap-5">
                ...
                {CardData.map((card, index) => (
                    <Link to={card.link} key={index} className="bg-background">
                        <div className="relative min-w-[450px]">
                            <div className="w-full h-full">
                                <svg width="100%" height="100%" viewBox="0 0 350 164" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1.18895e-05 28C1.32414e-05 12.536 12.5361 -2.9502e-05 28 -2.81501e-05L322 -2.44784e-06C337.464 -1.09593e-06 350 12.536 350 28L350 86C350 100.359 338.359 112 324 112C309.641 112 298 123.641 298 138C298 152.359 286.359 164 272 164L28 164C12.536 164 1.09593e-06 151.464 2.44784e-06 136L1.18895e-05 28Z" className={cn("fill-muted")} />
                                </svg>
                            </div>
                            ...
                            <span className="grid place-content-center bg-muted rounded-full p-2 size-[52px] absolute right-0 bottom-0">
                                <ChevronRight />
                            </span>
                        </div>
                    </Link>
