                ...
                <div className='h-[98px] w-64 bg-brand-background rounded-b-xl p-1 px-2'>
                    ...
                    {isLive && (
                        <p className='text-brand-secondary text-xs'>
                            Checkin Count - <span className='font-medium text-base'>999</span>
                        </p>
                    )}
...
//     return (
//         <div className={`${props.isLive ? 'w-full' : 'w-64'} flex rounded-xl shadow-blur-lg relative`}>
//             <div className={`h-64 flex flex-col`} >
//                 <div className='flex-1 overflow-hidden relative w-64'>
//                     <Button className='absolute w-8 h-8 bg-brand-secondary cursor-pointer rounded-full z-50 top-2 right-2'>
//                         <Trash />
//                     </Button>
