...
const EventCard: React.FC<EventCardProps> = ({
    ...
    return (
        <div className='w-xl flex bg-brand-background rounded-xl h-80'>
            {/* Image Div */}
            <div className='h-full flex flex-col relative justify-between min-w-80 overflow-hidden bg-brand-light-gray rounded-xl p-1.5'>
                {/* Live Tag */}
                <div className='max-w-fit h-14 absolute overflow-hidden'>
            ...
            <div className='w-full flex flex-col gap-2 p-1.5'>
                ...
                <div className='flex flex-col gap-2'>
                    <div className='flex gap-2'>
                        <div className='w-full h-14 rounded-2xl p-2 px-2.5 bg-brand-light-gray'>
                            <h6 className='font-semibold text-sm'>Registrations</h6>
                            <p className='text-xs mt-1'>800/900</p>
                        </div>
