                ...
                <div className='w-1/2 p-10 bg-white rounded-[10px]'>
                    <form className='max-w-[640px] mx-auto flex flex-col gap-5 !text-xl'>
                        ...
                        <div className='flex gap-[5px] border-b-brand-gray border-b-2 py-3 relative overflow-hidden'>
                            ...
                            <Input name="name" onChange={handleInputChange} type="text" placeholder='Full Name' className='min-h-full top-0 ml-9 absolute text-[21px] border-none focus-visible:ring-0' />
                        </div>
                        ...
                        <div className='flex gap-[5px] border-b-brand-gray border-b-2 py-3 relative overflow-hidden'>
                            ...
                            <Input name='email' onChange={handleInputChange} type="text" placeholder='Email Address' className='min-h-full top-0 ml-9 absolute text-[21px] border-none focus-visible:ring-0' />
                        </div>
                        ...
                        <div className='flex gap-[5px] border-b-brand-gray border-b-2 py-3 relative overflow-hidden'>
                            ...
                            <Input type="text" name="phone" onChange={handleInputChange} placeholder='Phone' className='min-h-full top-0 ml-9 absolute text-[21px] border-none focus-visible:ring-0' />
                        </div>
                        ...
                        <div className='flex gap-[5px] border-b-brand-gray border-b-2 py-3 relative overflow-hidden'>
                            ...
                            <Input type="text" name='subject' onChange={handleInputChange} placeholder='Subject' className='min-h-full top-0 ml-9 absolute text-[21px] border-none focus-visible:ring-0' />
                        </div>
                        ...
                        <div className='flex gap-[5px] border-b-brand-gray border-b-2 py-3 relative overflow-hidden'>
                            ...
                            <Textarea name="message" onChange={handleInputChange} rows={4} placeholder='Write your message here...' className='min-h-full top-0 ml-9 absolute text-[21px] border-none focus-visible:ring-0' />
                        </div>
                    </form>
                    <Button onClick={handleSubmit} className='mt-11 btn !h-16 !rounded-full !font-semibold text-2xl w-[238px]'>Send Message</Button>
                </div>
            </div>
