      ...
      <div className='max-w-5xl mx-auto my-10 space-y-8 text-black flex-grow'>
        ...
        <div className='space-y-4'>
          ...
          <ul className='list-disc pl-6 space-y-2'>
            ...
            <li>If you've done all of this and you still have not received your refund yet, please contact us at <span className="text-brand-primary">value@klout.club</span></li>
          </ul>
        </div>
        ...
        <div className='space-y-4'>
          ...
          <p>We only replace items if they are defective or damaged. If you need to exchange it for the same item, send us an email at <span className="text-brand-primary">value@klout.club</span> and send your item to:</p>
        ...
        <div className='space-y-4'>
          ...
          <p>Contact us at <span className="text-brand-primary">value@klout.club</span> for questions related to refunds and returns.</p>
        </div>
      </div>
    </div>
  )
